...
const qaPair1 = new QuestionAnswerPair(
  q1,
  [aFunctions, new Answer("XHTML"), aCSS, aHTML],
  aFunctions
);
...
const qaPair2 = new QuestionAnswerPair(
  q2,
  [aHTML, aJQuery, aCSS, new Answer("XML")],
  aCSS
);
...
const qaPair3 = new QuestionAnswerPair(
  q3,
  [aPythonScript, aJQuery, new Answer("Django"), new Answer("Node JS")],
  aPythonScript
);
...
function QuizPage(pageIndex, qaPair, qaPairArray) {
  ...
  this.display = function () {
    ...
    // Update bottom question progress bar
...
function QuizApplication(qaPairArray) {
  ...
  this.handleUserAnswerSelection = function (event) {
    ...
    // Check whether the user-responses is correct or not
